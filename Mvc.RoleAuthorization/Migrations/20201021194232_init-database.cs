        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArFullName = table.Column<string>(maxLength: 150, nullable: true),
                    EnFullName = table.Column<string>(maxLength: 150, nullable: true),
                    JobTitle = table.Column<string>(nullable: true),
                    BirthDay = table.Column<DateTime>(nullable: true),
                    StoppedReason = table.Column<string>(nullable: true),
                    ...
                    LastTokenPhoneDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
